...
const TRANSLATIONS = {
    es: {
        ...
        ai_hint: "El LLM local (Ollama) es 100% opcional y solo se activa si lo configuras explícitamente (MARTIX_LLM=1); tus archivos nunca salen a la nube.",
    ...
    en: {
        ...
        ai_hint: "Local LLM (Ollama) is 100% optional and only active if explicitly enabled (MARTIX_LLM=1); your files never leave your computer.",
